...
import { getCampById } from 'apiSdk/camps';
...
import { TransportationListPage } from 'pages/transportation';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('camp', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/camps/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="camp" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
